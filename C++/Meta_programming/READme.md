...
### ⚙️ Core Features:
   ...
   1- Numeric Operations: The library will feature the following key numeric operations:
        ...
        sum : Return the summation of it's arguments 

    2- Template Programming: All functions must be implemented using C++ templates, allowing them to accept one or more parameters of arithmetic data types (e.g., int, float, double).
